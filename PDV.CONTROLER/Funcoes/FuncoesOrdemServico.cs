    ...
    public static class FuncoesOrdemServico
    {
        public static List<OrdemDeServicoGridViewModel> GetOrdensDeServico(DateTime dataDe, DateTime dataAte)
        {
            using(SQLQuery oSQL = new SQLQuery())
            {
                ...
                oSQL.ParamByName["FATURADO"] = DAO.Enum.StatusPedido.Faturado;
                oSQL.ParamByName["ABERTO"] = DAO.Enum.StatusPedido.Aberto;
                oSQL.ParamByName["CANCELADO"] = DAO.Enum.StatusPedido.Cancelado;
                oSQL.Open();
