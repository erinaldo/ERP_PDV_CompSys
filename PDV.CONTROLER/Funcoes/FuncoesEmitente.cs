    ...
    public class FuncoesEmitente
    {
        ...
        public static bool SalvarEmitente(Emitente _Emitente, TipoOperacao Op)
        {
            using (SQLQuery oSQL = new SQLQuery())
            {
                    ...
                    case TipoOperacao.INSERT:
                        oSQL.SQL = @"INSERT INTO EMITENTE(
                                                ...
                                                LOGOPROPRAGANDA, NOMELOGOPROPRAGANDA,
                                                  PROXIMONUMERONFE, PROXIMONUMERONFCE, MODELOIMPRESSAODAV,ModeloSat,Homologacao,ImpressoraSat)
                    ...
                    case TipoOperacao.UPDATE:
                        oSQL.SQL = @"UPDATE EMITENTE
                                       SET IDENDERECO               = @IDENDERECO,
                                        ...
                                        PASTAXML = @PASTAXML,
                                        ModeloSAT = @ModeloSat,
                                        Homologacao = @Homologacao, ImpressoraSat = @ImpressoraSat
                                        WHERE IDEMITENTE = @IDEMITENTE";
                        break;
                }
                ...
                oSQL.ParamByName["ModeloSat"] = _Emitente.ModeloSAT;
                oSQL.ParamByName["Homologacao"] = _Emitente.Homologacao;
                oSQL.ParamByName["ImpressoraSat"] = _Emitente.ImpressoraSat;
                return oSQL.ExecSQL() == 1;
            }
        }
            ...
            using (SQLQuery oSQL = new SQLQuery())
            {
                oSQL.SQL = @"SELECT IDEMITENTE, 
                                    ...
                                    chaveAcessoValidador,pastaxml,
                                        ...
                                        PROXIMONUMERONFE,
                                        PROXIMONUMERONFCE,
                                        MODELOIMPRESSAODAV,ModeloSAT,Homologacao, ImpressoraSat
                               FROM EMITENTE";
                oSQL.Open();
                if (oSQL.IsEmpty)
                    return null;
        ...
        public static Emitente GetEmitentePorID(decimal IDEmitente)
        {
            using (SQLQuery oSQL = new SQLQuery())
            {
                oSQL.SQL = @"SELECT IDEMITENTE, 
                                    ...
                                    CRegTribISSQN  ,
                                    IndRatISSQN ,
                                    chaveAcessoValidador,ModeloSAT,Homologacao,ImpressoraSat
