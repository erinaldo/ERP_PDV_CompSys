...
{
    public partial class GFIN_MEstoquePorCompra : DevExpress.XtraEditors.XtraForm
    {
        public List<MovimentoDeEstoquePorCompraGridViewModel> MovimentoEstoquePorVenda { get; set; }
        public GFIN_MEstoquePorCompra()
        {
            InitializeComponent();
            PreencherDatas();
            Pesquisar();
        ...
        {
            Grids.FormatGrid(ref gridView1, "ID DA COMPRA");
        ...
        private void Pesquisar()
        {
            try
            {
                var pesquisa = new MovimentoDeEstoquePorCompraQueryModel
                {
                    DataDe = dataDe.DateTime.Date,
                    DataAte = dataAte.DateTime.Date,
                    Pesquisa = textBoxPesquisaProduto.Text
                };
                MovimentoEstoquePorVenda = FuncoesItemPedidoCompra.GetMovimentoPorCompra(pesquisa);
