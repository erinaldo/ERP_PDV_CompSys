        ...
        private void Cancelar()
        {
            try
            {
                if (ovTXT_Justificativa.Text.Length > 15)
                {
                    ...
                    var vendaFaturamento = new VendaFaturamento(movimento.IDVenda.Value, Contexto.USUARIOLOGADO);
                    vendaFaturamento.CancelarVenda(ovTXT_Justificativa.Text.Trim());
