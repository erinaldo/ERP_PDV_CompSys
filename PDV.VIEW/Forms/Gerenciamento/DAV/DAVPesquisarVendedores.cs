...
{
    public partial class DAVPesquisarVendedores : DevExpress.XtraEditors.XtraForm
    {
        public string Codigo { get; set; }
        public string Nome { get; set; }

        public DAVPesquisarVendedores()
        {
            InitializeComponent();
            var usuarios = FuncoesUsuario.GetUsuariosVendedores();
            gridControl1.DataSource = FuncoesUsuario.GetUsuariosVendedores();
            gridView1.OptionsView.ColumnAutoWidth = true;
            gridView1.OptionsView.ShowAutoFilterRow = true;
            //Formatação
            gridView1.Columns[0].Caption = "ID VENDEDOR";
