...
namespace PDV.VIEW.Forms.Configuracoes
{
    public partial class FCONFIG_Email : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Teste realizado às {1} do dia {2}.<br/>", ovTXT_EmailTeste.Text, DateTime.Now.ToString("HH:mm:ss"), DateTime.Now.ToString("dd/MM/yyyy"), string.Format("Comp-Sys  {0}", Contexto.VERSAO));
