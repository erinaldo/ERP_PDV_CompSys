...
(@"[nomeDest], 
        ...
        private void PreencheTela()
        {
            ...
            modeloSATComboBox.Text = _Emitente.ModeloSAT;
            impressoraSATComboBox.Text = _Emitente.ImpressoraSat;
            testeHomologacaoCheckBox1.Checked = _Emitente.Homologacao;
        }
        ...
        private void ovBTN_Salvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _Emitente.ModeloSAT = modeloSATComboBox.Text;
                _Emitente.ImpressoraSat = impressoraSATComboBox.Text;
                _Emitente.Homologacao = testeHomologacaoCheckBox1.Checked;
        ...
        {
            if (string.IsNullOrEmpty(modeloSATComboBox.Text))
            { 
                throw new Exception("Informe o modelo SAT.");
            }
            if (string.IsNullOrEmpty(impressoraSATComboBox.Text))
            {
                throw new Exception("Informe a impressora do SAT.");
            }
        ...
        private void satSPCheckBox1_CheckedChanged(object sender, EventArgs e)
        {
            satCECheckBox.Checked = false;
            mfeGroupBox.Enabled = false;
        }

        private void satCECheckBox_CheckedChanged(object sender, EventArgs e)
        {
            satSPCheckBox1.Checked = false;
            mfeGroupBox.Enabled = true;
