...
{
    public partial class FCO_HistoricoClienteFornecedor : MetroForm
    {
        private string NOME_TELA = "CONSULTA HISTÓRICOS DE ";
        public FCO_HistoricoClienteFornecedor()
        {
            InitializeComponent();
        }

        private void AtualizaAlmoxarifados(string Codigo, string Descricao)
        {
        ...
        private void FCO_HistoricoClienteFornecedor_Load(object sender, EventArgs e)
        {
            //AtualizaNCMS(ovTXT_Codigo.Text, ovTXT_Descricao.Text);
        }
    }
