...
namespace PDV.VIEW.FRENTECAIXA.Forms.PDV.Menu
{
    public partial class GPDV_MenuConfiguracoes : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FecharCaixa()
        {
            try
            {
                ...
                if (frm.Fechou)
                {
                    ...
                    formarPagamentoControl.Visible = true;
                    totaber.Visible = true;
                    totsup.Visible = true;
                    totsan.Visible = true;
                    totven.Visible = true;
                    totdin.Visible = true;
        ...
        public void chartProdutosMaisVendidos()
        {
            ...
            {
                //ChartControl
                formarPagamentoControl.AnimationStartMode = DevExpress.XtraCharts.ChartAnimationMode.OnLoad;
                formarPagamentoControl.BorderOptions.Visibility = DevExpress.Utils.DefaultBoolean.False;
                formarPagamentoControl.AutoLayout = true;
                formarPagamentoControl.Legend.Visibility = DevExpress.Utils.DefaultBoolean.True;
                ...
                formarPagamentoControl.Titles.Add(chartTitle);
                //Series
                ...
                formarPagamentoControl.Series.Add(series);
            }
        }
