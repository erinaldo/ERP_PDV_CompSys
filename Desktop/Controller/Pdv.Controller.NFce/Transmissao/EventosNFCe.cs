...
namespace PDV.CONTROLLER.NFCE.Transmissao
{
    public class EventosNFCe : IConfigNFCe
    {
        ...
        protected List<pag> GetPagamento(List<DuplicataNFCe> Pagamentos)
        {
            List<pag> ListaDePagamentos = new List<pag>();
            ...
            foreach (DuplicataNFCe Item in Pagamentos)
            {
                ...
                {
                    tPag = retornarFormaPagamento(Item.FormaDePagamento),
                    vPag = Item.Valor
                };
