...
namespace PDV.UTIL.FORMS.Forms
{
    ...
    public enum CryptProvider
    {
        ...
        /// Representa a classe base para implementações criptografia dos algoritmos simétricos.
    ...
    public class CriptografiaSystem
    {
        ...
        public CriptografiaSystem(CryptProvider cryptProvider)
        {
