...
{ 
    public partial class Modelo3Unidade : DevExpress.XtraReports.UI.XtraReport
    {
        private DataTable dt = new DataTable();
        public decimal IdVenda { get; set; }

        public Modelo3Unidade(decimal idVenda)
        {
        ...
        private void GerarColunaTotal()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
                CalcularTotal(dt.Rows[i]);
        }

        private void CalcularTotal(DataRow dataRow)
        {
            ...
            dataRow["total"] = ItemVendaUtil.GetTotalItem(quantidade, preco, desconto, area != 0 ? area : 1);
