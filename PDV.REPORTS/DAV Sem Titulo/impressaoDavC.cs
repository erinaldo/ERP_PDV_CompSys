...
{
    public partial class impressaoDavC : DevExpress.XtraReports.UI.XtraReport
    {
        int subreportRowsCount = 4;
        int Itens = 0;
        decimal _IDVENDA = 0;
        public impressaoDavC(decimal IDVENDA)
        {
            _IDVENDA = IDVENDA;
            InitializeComponent();
            ...
            xrSubreport2.ReportSource = new SubimpressaoDavC(_IDVENDA);
            xrSubreport1.ReportSource = new SubimpressaoDavC(_IDVENDA);
